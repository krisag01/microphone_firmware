...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x00B9, 0x00BA, 0x00EB, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0007, 0x0006, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 
    ...
    /*0x0160*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xADB7, 0x7009, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 
    /*0x0180*/ 0x2531, 0xA6FE, 0xFB00, 0x7078, 0xFB54, 0x7018, 0xFB4C, 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 0x7875, 0x14EC, 0x0877, 0x6403, 
    /*0x01A0*/ 0x601F, 0xEB2C, 0xFDB1, 0xE902, 0x7079, 0xEF3F, 0x7876, 0x14EC, 0x6403, 0x601F, 0xEB2C, 0xFDB1, 0xE902, 0x7099, 0xEF3F, 0x8801, 
    /*0x01C0*/ 0x8A20, 0xBE01, 0x0000, 0x0C77, 0x0878, 0x8801, 0x0C78, 0x14F9, 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8, 
    /*0x01E0*/ 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 0xFD47, 0xEB49, 0x1465, 0xADB7, 0x1462, 0x7079, 0xFB55, 0x71FB, 0xFB54, 0xFD47, 0xFB54, 
    /*0x0200*/ 0x1465, 0x4431, 0x4400, 0xADB7
};
...
//  cfg         input       output      state       
    0x002010EA, 0x00000000, 0x042010EE, 0x00000000  // Reading
};
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_READING_TASK_ID)) {
        scifReinitIo(7, -1, 0);
        scifReinitIo(6, -1, 0);
    }
} // scifReinitTaskIo
